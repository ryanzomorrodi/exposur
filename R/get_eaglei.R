...
eia_url <- "https://www.eia.gov/electricity/data/browser/data/index.php?method=getMapData&geosetId=ELEC.CUSTOMERS.ALL.A&freq=A&topic=56"
...
download_eia_customers <- function(year) {
  ...
  eia_dates <- tibble::tibble(year = unlist(purrr::pluck(eia_body, 1)))
